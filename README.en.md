...
| Tests | **197 / 197 passing**, including real-filesystem end-to-end runs, time-display/time-zone consistency, cross-timestamp custom restores, custom deletion, protection-range removal, whole-directory restores, pre-release permission/scope/privacy cases, and the v0.2.1 safety hotfix cases for physical boundaries and serialized restores |
